...
hadoop fs -mkdir -p /user/hive/warehouse/edv2015.db/wide_table_text
...
hadoop fs -mv /tmp/fakedata_uuid.dat.snappy/p* /user/hive/warehouse/edv2015.db/wide_table_text

hadoop fs -mkdir -p /user/hive/warehouse/edv2015.db/drwho_text
hadoop fs -put drwho.dat /user/hive/warehouse/edv2015.db/drwho_text/.
